...
1. Which function is used to obtain keyboard input?
   * input()
2. How does the input() function know when the user is done entering data?
   * When they press the Return key.
3. Which function is used to provide output to the screen?
   * print()
4. How are comments annotated in Python?
   * #
5. How does Python handle in-code comments?
   * Ignores them